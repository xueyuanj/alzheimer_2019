...
endogenes = endogenes[!totalgenes %in% mtgenes]
...
# dam markers
FeaturePlot(injure_seurat_filter, features = c("Apoe", "Cst7", "Lpl", "Spp1"), reduction = "tsne")

# ir1 markers
FeaturePlot(injure_seurat_filter, features = c("P2ry12", "Selplg", "Cx3cr1"), reduction = "tsne")

# ir2 overall markers
FeaturePlot(injure_seurat_filter, features = c("Ifi27l2a", "Ifi204", "Cxcl10", "Ccl4"), reduction = "tsne")
...
controwb = filter(injurmouse, grepl("contro", title))
salinewm = filter(injurmouse, grepl("saline", title))
lpcwm = filter(injurmouse, grepl("LPC", title))
...
UMAPPlot(object = injure_seurat_filter, cells.highlight = contrlwb_wells)
UMAPPlot(object = injure_seurat_filter, cells.highlight = salinewm_wells)
UMAPPlot(object = injure_seurat_filter, cells.highlight = lpcwm_wells)


TSNEPlot(object = injure_seurat_filter, cells.highlight = contrlwb_wells)
TSNEPlot(object = injure_seurat_filter, cells.highlight = salinewm_wells)
TSNEPlot(object = injure_seurat_filter, cells.highlight = lpcwm_wells)
